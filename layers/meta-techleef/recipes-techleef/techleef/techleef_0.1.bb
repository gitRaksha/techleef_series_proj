...
SRC_URI = "file://techleef.c"

# SRC_URI is the source of the project/files to be compiled
...
do_compile(){
    ${CC} ${WORKDIR}/techleef.c ${LDFLAGS} -o ${WORKDIR}/techleef
}

do_install(){
    install -d ${D}/usr/bin
    install -m 0744 ${WORKDIR}/techleef ${D}/usr/bin
}